...
void open_about_dialog(int ID, int dpX, int dpY)
{
	...
	about = GLUI_Master.create_glui("About VICS",0,dpX,dpY );
...
//-------------------------------------------------------------------------------------------//
	...
	line1 = about->add_statictext_to_panel(welcome_panel,"VICS");
	line2 = about->add_statictext_to_panel(welcome_panel,"VIsualization of Crystal Structures");
	line3 = about->add_statictext_to_panel(welcome_panel,"Ver. 2.6");
	about->add_separator_to_panel(welcome_panel);
